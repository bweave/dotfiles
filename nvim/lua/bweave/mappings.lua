...
map('n', '<space>gD', '<cmd>lua vim.lsp.buf.declaration()<CR>')
map('n', '<space>gd', '<cmd>lua vim.lsp.buf.definition()<CR>')
map('n', '<space>gi', '<cmd>lua vim.lsp.buf.implementation()<CR>')
map('n', '<space>gn', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>')
map('n', '<space>gp', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>')
map('n', '<space>gr', '<cmd>lua vim.lsp.buf.references()<CR>')
map('n', '<space>rn', '<cmd>lua vim.lsp.buf.rename()<CR>')
map('n', '<space>sl', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>')
