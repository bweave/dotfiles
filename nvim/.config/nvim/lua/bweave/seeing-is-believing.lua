...
function sib_annotate_all()
	local fn = function()
		vim.cmd(
			"% !seeing_is_believing --timeout 12 --line-length 500 --number-of-captures 300 --alignment-strategy chunk"
		)
	end
...
function sib_annotate_marked()
	local fn = function()
		vim.cmd(
			"% !seeing_is_believing --xmpfilter-style --timeout 12 --line-length 500 --number-of-captures 300 --alignment-strategy chunk"
		)
	end
	without_changing_cursor(fn)
end
